...
![git components](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/components.png){:class="img-in-card"}
...
![Cloning the remote repo](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/clone.png){:class="img-in-card"}
...
![Adding changes to the staging area](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/add.png){:class="img-in-card"}
...
![Committing to the local repo](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/commit.png){:class="img-in-card"}
...
![Pushing to the local repo](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/push.png){:class="img-in-card"}
...
![State of all components after pushing changes](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/after_push.png){:class="img-in-card"}
...
![States of a change an related diff commands](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/diffs.png){:class="img-in-card"}
...
![State after adding branch](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/add_branch.png){:class="img-in-card"}
...
![State after after switching branch](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/checkout_branch.png){:class="img-in-card"}
...
![Remote and local branches`](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/branches.png){:class="img-in-card"}
...
![Before fast forward merge](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/before_ff_merge.png){:class="img-in-card"}

The second diagram shows what has changed with our `merge`.

![After fast forward merge](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/ff_merge.png){:class="img-in-card"}
...
![Divergent commits](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/branches_diverge.png){:class="img-in-card"}
...
![Merging branches](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/merge.png){:class="img-in-card"}
...
![History before a rebase](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/before_rebase.png){:class="img-in-card"}
...
![History after rebase](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/rebase.png){:class="img-in-card"}
...
![many dev environments](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/many_dev_environments.png){:class="img-in-card"}
...
![github edit](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/github.png){:class="img-in-card"}
...
![Fetching changes](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/fetch.png){:class="img-in-card"}
...
![Pulling in changes](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/pull.png){:class="img-in-card"}
...
![Branches before cherry-picking](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/cherry_branches.png){:class="img-in-card"}
...
![Cherry-picking a single commit](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/cherry_pick.png){:class="img-in-card"}
...
![Cherry-picking commit range](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/cherry_pick_range.png){:class="img-in-card"}
...
![What happens in a push --force-with-lease](https://raw.githubusercontent.com/UnseenWizzard/git_training/master/img/force_push.png){:class="img-in-card"}
